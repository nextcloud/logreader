OC.L10N.register(
    ...
    "Failed to get an iterator for log entries: %s" : "تعذّر الحصول على مُكرِّر لإدخاليات سجل الأنشطة : %s",
    ...
    "If you feel this is an error, please verify {setting} in your {config} and check the Nextcloud Administration Manual." : "إذا كنت تشعر أن هذا خطأ، فيُرجى التحقُّق من {setting} في {config} و مراحعة دليل التشغيل لمسؤول النظام في نكست كلاود.",
    "Level" : "الدرجة",
    "App" : "التطبيق",
