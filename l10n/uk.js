OC.L10N.register(
    ...
    "Live view is disabled" : "Перегляд наживо вимкнено",
    ...
    "Time" : "Час",
    "Copy raw entry" : "Копіювати неформатований запис",
    "Copy formatted entry" : "Копіювати форматований запис",
    "Hide exception details" : "Приховати деталі винятку",
    "View exception details" : "Показувати деталі винятку",
    "Raw log entry" : "Неформатований запис журналу",
    ...
    "Live view" : "Наживо",
    "Download/Upload logs" : "Журнал звантаження/завантаження",
    ...
    "(Local log files only support the \"raw\" time format)" : "(Файли журналів на пристрої підтримують тільки неформатований формат часу)",
    ...
    "Polling (live view)" : "Надсилання запитів (перегляд наживо)",
    "Could not change live view setting." : "Не вдалося змінити налаштування перегляду наживо.",
    "Filter logging levels" : "Фільтр рівнів журналювання",
