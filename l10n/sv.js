OC.L10N.register(
    ...
    "Failed to get an iterator for log entries: %s" : "Det gick inte att skapa en iterator för loggposter: %s",
    ...
    "If you feel this is an error, please verify {setting} in your {config} and check the Nextcloud Administration Manual." : "Om du tror att detta är ett fel kontrollerar du {setting} i {config} och läser Nextclouds administrationshandbok.",
    "Log reader" : "Loggläsare",
    ...
    "Time" : "Tid",
    "Copy raw entry" : "Kopiera rå post",
    ...
    "Download/Upload logs" : "Hämta/ladda upp loggar",
    "Ctrl" : "Ctrl",
    "Could not parse local log file" : "Det gick inte att tolka den lokala loggfilen",
    ...
    "Could not change date time format." : "Det gick inte att ändra formatet för datum och tid.",
    "Raw data" : "Rådata",
    "Local time" : "Lokal tid",
    "UTC time" : "UTC-tid",
    "Relative" : "Relativ",
    "Could not change live view setting." : "Det gick inte att ändra inställningen för live-uppdatering.",
    "Polling is disabled because server is not configured to log to file" : "Avsökning är inaktiverad eftersom servern inte är konfigurerad för filloggning",
    "Polling (live view)" : "Avsökning (livevisning)",
    "Could not set logging levels to show" : "Det gick inte att ställa in loggningsnivåer som ska visas",
    "Filter logging levels" : "Filtrera loggningsnivåer",
    "Could not set logging level" : "Det gick inte att ställa in loggningsnivå",
    "Set backend loglevel" : "Ange loggnivå för bakänden",
    "Application" : "App",
    "Message" : "Meddelande",
    ...
    "Collapse row" : "Fäll ihop rad",
    "Expand row" : "Fäll ut rad",
    ...
    "Error" : "Fel",
    "Fatal" : "Kritiskt",
    "Could not load log entries" : "Det gick inte att läsa in loggposter",
    "Clipboard" : "Urklipp",
    "Could not parse clipboard content" : "Det gick inte att tolka innehållet i urklipp",
    "Could not fetch new log entries (server unavailable)" : "Det gick inte att hämta nya loggposter (servern är inte tillgänglig)",
    "Could not fetch new entries" : "Det gick inte att hämta nya poster",
    "Could not copy to clipboard, please copy manually:" : "Det gick inte att kopiera till urklipp. Kopiera manuellt:",
