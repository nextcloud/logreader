OC.L10N.register(
    ...
    "Currently the logfile {file} is shown" : "För närvarande visas loggfilen {file}",
    ...
    "Log entry sucessfully copied" : "Loggposten har kopierats",
    ...
    "Show local logfile" : "Visa lokal loggfil",
