OC.L10N.register(
    ...
    "Currently the logfile {file} is shown" : "Atualmente, o arquivo de log {file} é mostrado",
    ...
    "If you feel this is an error, please verify {setting} in your {config} and check the Nextcloud Administration Manual." : "Se você acha que isso é um erro, verifique {setting} em seu {config} e verifique o Manual de administração do Nextcloud.",
    "Level" : "Nível",
    "App" : "Aplicativo",
    ...
    "Log entry sucessfully copied" : "Entrada de registro copiada com sucesso",
    ...
    "Show local logfile" : "Mostrar arquivo de log local",
