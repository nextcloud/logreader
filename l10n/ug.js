OC.L10N.register(
    ...
    "_%n error in the logs since %s_::_%n errors in the logs since %s_" : ["%s دىن بۇيان خاتىردە %n دانە خاتالىقلار بار","%s دىن بۇيان خاتىردە %n دانە خاتالىقلار بار"],
    "_%n warning in the logs since %s_::_%n warnings in the logs since %s_" : ["%s دىن بۇيان خاتىردە %n دانە ئاگاھلاندۇرۇش بار","%s دىن بۇيان خاتىردە %n دانە ئاگاھلاندۇرۇش بار"],
    "Log Reader" : "خاتىرە ئوقۇغۇ",
    "A log reader for Nextcloud" : "Nextcloud ئۈچۈن خاتىرە ئوقۇغۇچ",
    "Log reader for Nextcloud" : "Nextcloud ئۈچۈن خاتىرە ئوقۇغۇچ",
    "If you feel this is an error, please verify {setting} in your {config} and check the Nextcloud Administration Manual." : "ئەگەر بۇ خاتالىق دەپ قارىسىڭىز ، {setting} دىكى {config} نى تەكشۈرۈپ ، كېيىنكى بۇلۇت باشقۇرۇش قوللانمىسىنى تەكشۈرۈپ بېقىڭ.",
    "Log reader" : "خاتىرە ئوقۇغۇچ",
    "Open log reader settings" : "خاتىرە ئوقۇغۇچ تەڭشىكىنى ئېچىڭ",
    "Log reader settings" : "ئوقۇرمەن تەڭشىكى",
    "Currently the log file {file} is shown" : "ھازىر خاتىرە ھۆججىتى {file} كۆرسىتىلدى",
