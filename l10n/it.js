OC.L10N.register(
    ...
    "_%n error in the logs since %s_::_%n errors in the logs since %s_" : ["%n errore nei log dal %s","%n errori nei log dal %s","%n errori nei log dal %s"],
    "_%n warning in the logs since %s_::_%n warnings in the logs since %s_" : ["%n avviso nei log dal %s","%n avvisi nei log dal %s","%n avvisi nei log dal %s"],
