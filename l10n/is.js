OC.L10N.register(
    ...
    "Failed to get an iterator for log entries: %s" : "Mistókst að fá talningu á atriðaskráningum: %s",
    ...
    "Ctrl" : "Ctrl",
    "Could not parse local log file" : "Mistókst að túlka staðværa atvikaskrá (log)",
    "You can also show log entries copied from your clipboard by pasting them on the log view using: {keyboardShortcut}" : "Þú getur líka birt færslur atvikaskráningar sem afriðaðar eru úr klippispjaldinu þínu með því að líma þær inn í atvikaskoðarann með: {keyboardShortcut}",
    ...
    "Clipboard" : "Klippispjald",
    "Could not parse clipboard content" : "Mistókst að túlka efni á klippispjaldi",
