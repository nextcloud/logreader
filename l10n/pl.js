OC.L10N.register(
    ...
    "Log Reader" : "Dziennik logów",
    "A log reader for Nextcloud" : "Dziennik logów dla Nextcloud",
    "Log reader for Nextcloud" : "Dziennik logów dla Nextcloud",
    "Log reader" : "Dziennik logów",
    "Open log reader settings" : "Otwórz ustawienia dziennika logów",
    "Log reader settings" : "Ustawienia dziennika logów",
    ...
    "Level" : "Poziom",
    "App" : "Aplikacja",
    "No app in context" : "Brak aplikacji w kontekście",
    "Time" : "Czas",
    "Copy raw entry" : "Kopiuj nieprzetworzony wpis",
    "Copy formatted entry" : "Kopiuj sformatowany wpis",
    "Hide exception details" : "Ukryj szczegóły wyjątku",
    "View exception details" : "Wyświetl szczegóły wyjątku",
    "Raw log entry" : "Nieprzetworzony wpis dziennika",
    "Log entry successfully copied" : "Wpis dziennika został pomyślnie skopiowany",
    "Search log entries" : "Szukaj wpisy dziennika",
    ...
    "Error parsing log" : "Błąd podczas analizowania dziennika",
    "Caused by " : "Spowodowany",
    "Copy" : "Kopiuj",
    "Copy raw" : "Kopiuj nieprzetworzony",
    "Copy formatted" : "Kopiuj sformatowany",
    "No server logs" : "Brak logów serwera",
    "One or more entries are hidden by the log level filter" : "Jeden lub więcej wpisów jest ukrytych przez filtr poziomu dziennika",
