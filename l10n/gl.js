OC.L10N.register(
    ...
    "Currently the logfile {file} is shown" : "Agora amosase o ficheiro de rexistro {file}",
    ...
    "File-based logging must be enabled to access logs from the Web UI." : "Para acceder aos rexistros dende a IU web ten que estar activado o rexistro baseado en ficheiros.",
    ...
    "Time" : "Hora",
    "Copy raw entry" : "Copiar a entrada en bruto",
    ...
    "Download / Upload logs" : "Descargar / cargar rexistros",
    "Download logs" : "Descargar rexistros",
    "Show local logfile" : "Amosar o ficheiro de rexistro local",
    "Upload local log file to be displayed" : "Cargar o ficheiro de rexistro local para amosalo",
    ...
    "(Local log files only support the \"raw\" time format)" : "(Os ficheiros de rexistro locais só admiten o formato de hora «en bruto»).",
    ...
    "Could not set logging levels to show" : "Non foi posíbel estabelecer os niveis do rexistro para amosar",
    ...
    "Copy" : "Copiar",
    "Copy raw" : "Copia en bruto",
    "Copy formatted" : "Copia con formato",
