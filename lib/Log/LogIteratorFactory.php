...
class LogIteratorFactory
{
	...
	public function getLogIterator($levelsString) {
		...
		if ($selectedLogFile && $this->systemConfig->getValue('logAdditional', $selectedLogFile)) {
			$selectedLogFilePath = $this->systemConfig->getValue('logAdditional', $selectedLogFile)[$selectedLogFile];
